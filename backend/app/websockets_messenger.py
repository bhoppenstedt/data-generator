...
class Websockets_message_producer(object):
    ...
    def __init__(self, type, name, args, test_client):
    ...
    def sendRandomSignal(self):
        ...
        while(self.running):
            ...
            socketio.emit('random_test_event', {'data': random_number})
            print("one number emitted")
    ...
    def sendSinusSignal(self):
        ...
        while(self.running):
            for i in range(0, 360):
                ...
                socketio.emit('sinus_test_event', {'data': periodic_number})
                print("one number emitted")
                print(test_client.get_received())
                sleep(self.transmissionFrequency)
    ...
    def sendCosinusSignal(self):
        ...
        while(self.running):
            for i in range(0, 360):
                ...
                print(f"Emitting number {periodic_number}")
                socketio.emit('cosinus_test_event', {'data': periodic_number})
                print("one number emitted")
                print(test_client.get_received())
                sleep(self.transmissionFrequency)
    ...
    def sendEmphasizedRandomSignal(self):
        ...
        while(self.running):
            ...
            for i in data:
                ...
                socketio.emit('emphasized_test_event', {'data': emphasized_number})
                print("one number emitted")
                print(test_client.get_received())
                sleep(self.transmissionFrequency)
    ...
    def sendSpikedSignal(self):
        ...
        while(self.running):
            ...
            socketio.emit('spiked_test_event', {'data': spiked_number})
            print("one number emitted")
            print(test_client.get_received())
            sleep(self.transmissionFrequency)
            i = i + 1
